package com.webclient1c.release02.spring;
...
@Configuration
@ComponentScan({ "com.webclient1c.release02" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.webclient1c.release02");
                servletContext.setInitParameter("tapestry.development-modules", "com.webclient1c.release02.services.DevelopmentModule");
