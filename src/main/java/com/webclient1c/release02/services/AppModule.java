...
public class AppModule {
	...
	private static final org.apache.logging.log4j.Logger logger = LogManager.getLogger(AppModule.class);
		
    public static void bind(ServiceBinder binder) {
        // binder.bind(MyServiceInterface.class, MyServiceImpl.class);
        binder.bind(HibernateSession.class, HibernateSessionImpl.class);
    	logger.info("DataSyncService is STARTING TO binded");
        binder.bind(DataSyncService.class, DataSyncServiceImpl.class);
        binder.bind(StockLevelsSyncService.class, StockLevelsSyncServiceImpl.class);
        binder.bind(Http1CRequestConnector.class, Http1CRequestConnectorImpl.class);
...
/*    @Startup
    public static void scheduleJobs(PeriodicExecutor executor)
        {
        executor.addJob(new IntervalSchedule(21000),"StockLevelsSyncService", new Runnable() {
			@Override
			public void run() {
		    	StockLevelsSyncServiceImpl stockLevelsSyncService = new StockLevelsSyncServiceImpl();
				logger.info(" --- StockLevelsSyncService RUN started.");	
				stockLevelsSyncService.syncStockLevels();
			}
		});
    }
*/        
